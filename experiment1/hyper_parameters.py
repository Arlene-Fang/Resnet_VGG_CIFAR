...
tf.app.flags.DEFINE_integer('validation_batch_size', 150, '''Validation batch size, better to be
a divisor of 7500 for this task''')
...
tf.app.flags.DEFINE_string('test_ckpt_path', 'model.ckpt-70000', '''Checkpoint
directory to restore''')
